...
export function FetchDataSteps() {
  return (
		<ol className="flex flex-col gap-6">
			...
			{/* Row Level Security (RLS) is a database security feature that controls access to individual rows in your tables based on who is making the request. */}
      
      {/* What is RLS?: RLS allows you to create policies that determine which rows a user can see, insert, update, or delete */}

			{/* -- This policy says:
      -- "Anyone can READ data from the notes table"
      -- "No authentication required"
      -- "All rows are accessible for reading" */}
